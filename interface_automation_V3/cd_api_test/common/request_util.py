...
if __name__ == '__main__':
    url = "https://platform.htilarpay.com/myan/api/v1.0/user/login"
    r = RequestUtil()
    data = {'account': 'doqwmz09573@chacuo.net', 'password': 'Kv6O4Sv9'}
    headers = {}
    result = r.request(url, 'post', param=data, headers=headers, content_type="application/json")
    print(result)
